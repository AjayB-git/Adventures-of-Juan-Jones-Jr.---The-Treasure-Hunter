...
def draw_bg():
	...
	for x in range(4):
		...
		screen.blit(ruins_img, ((x * width) - scroll * 0.6, SCREEN_HEIGHT - ruins_img.get_height() - 300))
		screen.blit(forest1_img, ((x * width) - scroll * 0.7, SCREEN_HEIGHT - forest1_img.get_height() - 150))
		screen.blit(forest2_img, ((x * width) - scroll * 0.8, SCREEN_HEIGHT - forest2_img.get_height()))
