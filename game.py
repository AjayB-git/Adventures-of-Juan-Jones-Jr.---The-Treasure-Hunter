...
pygame.init()
mixer.init()
bgm = mixer.music.load("music/bg.wav")

SCREEN_WIDTH = 1200
SCREEN_HEIGHT = 720
screen = pygame.display.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
pygame.display.set_caption('Adventures of Juan Jones Jr. - The Treasure Hunter')
...
ruins_img = pygame.image.load('img/Background/ruins.png').convert_alpha()
...
class AudioManager:
    ...
    def load_audio(self):
        ...
        self.sounds['jump'] = pygame.mixer.Sound('music/jump.wav')
        self.sounds['coin'] = pygame.mixer.Sound('music/coin.wav')
...
class Game:
    ...
    def draw_bg(self):
        ...
        for x in range(bg_count):
            ...
            screen.blit(ruins_img, ((x * width) - self.scroll * 0.1, SCREEN_HEIGHT - ruins_img.get_height() - 300))
            screen.blit(forest1_img, ((x * width) - self.scroll * 0.7, SCREEN_HEIGHT - forest1_img.get_height() - 150))
            screen.blit(forest2_img, ((x * width) - self.scroll * 0.8, SCREEN_HEIGHT - forest2_img.get_height()))
